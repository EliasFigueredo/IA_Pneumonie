...
# # Cargar el modelo fuera del bloque de la interfaz para evitar cargarlo en cada ejecución
# model = load_model('chest_xray.h5')
...
# # Bloque principal con la interfaz
# with c30:
#     uploaded_file = st.file_uploader(
#         "Choisissez une image (JPG, JPEG, PNG)",
#         type=['jpg', 'jpeg', 'png'],
...
#         # Placeholder pour le modèle - Vous devez charger votre modèle ici (ya se cargó arriba)
